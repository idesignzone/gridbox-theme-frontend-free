      ...
      <div class="uk-section title-area uk-dark uk-background-muted">
          <div class="uk-container uk-container-large uk-margin-large-top">
              <div class="uk-grid-medium uk-flex-bottom uk-flex-between uk-text-center" data-uk-grid>
                    ...
                    >
                        <h5 class="animation-item">TAG</h5>
                        <h1 class="animation-item uk-margin-small-top" v-if="$page.WordPress.tag.name != null">{{ $page.WordPress.tag.name }}</h1>
                        <hr class="animation-item uk-divider-small uk-text-primary">
                        <div class="animation-item uk-margin-small-top" v-if="$page.WordPress.tag.description != null" v-html="$page.WordPress.tag.description"></div>
                    </div>
                    ...
                    <div class="uk-margin-medium-top breadcrumb">
                        <ul class="uk-breadcrumb">
                            ...
                            <li> 
                              <g-link to="/tag">Tag</g-link> 
                            </li>
                            <li>{{ $page.WordPress.tag.name }}</li>
                        </ul>
                    </div>
                ...
                <div class="uk-grid-medium" data-uk-grid>
                    <div class="uk-width-expand@m">
                        <div class="uk-grid-medium uk-child-width-1-2@m" data-uk-grid="masonry: true">
                            <div v-for="{ node } in $page.WordPress.tag.posts.edges" :key="node.id">
                                <Post :post="node"></Post>
                            </div>
                        </div>
